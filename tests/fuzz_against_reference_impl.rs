...
"#
    ...
    for i in 0..ITERATIONS {
        ...
        let expected_pubkey = Point::from_slice(expected_pubkey_bytes).unwrap_or_else(|_| panic!("error decoding aggregated public key from reference implementation: {}",
...
"#
    ...
    for i in 0..ITERATIONS {
        ...
        for k in 0..seckeys.len() {
            ...
            .unwrap_or_else(|_| panic!("failed to sign with randomly chosen keys and nonces: {}",
                debug_json));
